...
def index():
    ...
    <body>
        ...
        <div class="dashboard">
            ...
            <div class="panel">
                <div class="status-tag">STREAK RADAR // <span id="mode" style="color:var(--accent)">WAITING_INJECTION</span></div>
                <div class="label" style="font-size: 0.8em; color: #666; margin-bottom: 5px;">RISK PROBABILITY</div>
                <div id="risk" style="font-size: 2.5em; font-weight: bold;">--%</div>
                <div class="risk-bar"><div id="risk-fill" class="risk-fill" style="width:0%"></div></div>
                <p style="font-size: 0.8em; color: #444; margin-top: 20px;">CURRENT NONCE: <span id="nonce" style="color: #fff">--</span></p>
            </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px;">
                    <div>
                        <div class="input-group">
                            ...
                            <input type="text" id="in-server" value="" placeholder="Paste unhashed server seed...">
                        </div>
                        <div class="input-group">
                            <label>CLIENT SEED</label>
                            <input type="text" id="in-client" value="" placeholder="Current client seed...">
                        </div>
                    </div>
                    <div>
                        <div class="input-group">
